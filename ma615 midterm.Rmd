...
data <- readxl::read_xls("/Users/tsuyu/Downloads/Data\ science\ in\ R/project/World\ Bank\ Data/climate_change.xls",
         sheet = "Data")
# extract population, urban population and region data 
...
```{r warning=FALSE}
#allocate data in 1995 and 2005
...
urban_pop_perc %<>% 
  mutate(perc2005=as.numeric(urbanpop2005)/as.numeric(pop2005),
         ...
         perc_incre=perc2005-perc1995)  #calculate urban population percentage
...
```{r}
# find out what the outliners are
ECA <- urban_pop_perc3 %>% 
...
This is a list of the 10 countries whose urban population witnessed the greatest increase in the observed 10 years. 
...
Now one proceed to investigate into the relationship between the two variables. A positive relationship is suspected because CO2 emission can reflect the environmental impact of urbanization.
...
In 2005, the trend is similar although the actual slopes are slightly different.
